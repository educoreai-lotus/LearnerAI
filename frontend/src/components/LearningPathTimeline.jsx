                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {(module.estimated_duration_hours || module.duration) && (
                      <span className="text-sm font-medium text-primary-cyan bg-primary-cyan/10 px-3 py-1 rounded-full">
                  ...
                  {module.steps && module.steps.length > 0 && (
                    <div className="mt-4 pt-4 border-t border-emeraldbrand-200 dark:border-emeraldbrand-800">
                      <h4 className="text-sm font-semibold text-text-primary mb-4">
                        Steps in this module ({module.steps.length})
                      </h4>
                      <div className="space-y-4">
                        {module.steps.map((step, stepIndex) => (
                          <div key={stepIndex} className="bg-gradient-to-br from-bg-secondary to-bg-primary rounded-lg p-5 border border-emeraldbrand-200 dark:border-emeraldbrand-800 shadow-sm hover:shadow-md transition-shadow">
                            {/* Step Header */}
                            <div className="flex items-start justify-between mb-3">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  <span className="text-xs font-bold text-primary-cyan bg-primary-cyan/10 px-2 py-1 rounded">
                            ...
                            {step.objectives && step.objectives.length > 0 && (
                              <div className="mb-4">
                                <h6 className="text-sm font-semibold text-text-primary mb-2 flex items-center gap-2">
