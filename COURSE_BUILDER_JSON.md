...
| `learning_path` | Object (JSONB) | ✅ Yes | Complete learning path structure (JSONB from courses table) |
...
## 🔄 Difference from Learning Analytics Payload
...
- ✅ `learning_path` - Must be valid JSON object (JSONB from courses table)
...
**This JSON structure provides Course Builder with all the information needed to build the course content!** ✅
